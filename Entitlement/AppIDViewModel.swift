...
class AppIDModel : ObservableObject, Hashable {
    ...
    func addIncreasedMemory() async throws {
        ...
        request.httpBody = "{\"data\":{\"relationships\":{\"bundleIdCapabilities\":{\"data\":[{\"relationships\":{\"capability\":{\"data\":{\"id\":\"INCREASED_MEMORY_LIMIT\",\"type\":\"capabilitie[...]
    ...
    func addExtendedVirtualAddressing() async throws {
        ...
        request.httpMethod = "PATCH"
        request.allHTTPHeaderFields = httpHeaders
        request.httpBody = "{\"data\":{\"relationships\":{\"bundleIdCapabilities\":{\"data\":[{\"relationships\":{\"capability\":{\"data\":{\"id\":\"EXTENDED_VIRTUAL_ADDRESSING\",\"type\":\"capabilitie[...]
